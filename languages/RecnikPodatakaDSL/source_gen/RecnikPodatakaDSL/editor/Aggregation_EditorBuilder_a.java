...
/*package*/ class Aggregation_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new fieldsListHandler_tbnvmd_d0a(myNode, getEditorContext());
  ...
  private static class fieldsListHandler_tbnvmd_d0a extends RefNodeListHandler {
    ...
    public fieldsListHandler_tbnvmd_d0a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(fieldsListHandler_tbnvmd_d0a.this.getNode(), LINKS.fields$3GOB));
      try {
  ...
  private EditorCell createRefNodeList_1() {
    AbstractCellListHandler handler = new fieldDefListHandler_tbnvmd_a2a(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Vertical(), false);
    editorCell.setCellId("refNodeList_fieldDef");
    editorCell.setSRole(handler.getElementSRole());
    return editorCell;
  }
  private static class fieldDefListHandler_tbnvmd_a2a extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public fieldDefListHandler_tbnvmd_a2a(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(fieldDefListHandler_tbnvmd_a2a.this.getNode(), LINKS.fieldDef$w9nV));
      try {
        EditorCell emptyCell = null;
        emptyCell = super.createEmptyCell();
        installElementCellActions(null, emptyCell, true);
